...
async def make_changes_command(message: types.Message):
    ...
    await bot.send_message(message.from_user.id, "Мой Господин", reply_markup=admin_kb.button_case_admin)
...
async def del_callback_run(callback_query: types.CallbackQuery):
    await sqlite.sql_delete_command(callback_query.data.replace("del ",""))
